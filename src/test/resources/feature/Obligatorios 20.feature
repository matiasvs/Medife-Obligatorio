Feature: Med 162 - Obligatorios 20 - Validar comportamiento pantalla segun valor campo Condición de IVA "Monotributo"
  ...
  Scenario Outline: Comportamiento
    ...
    When Obligatorio x Cuando se seleciona el valor <Monotributo> para el campo Condicion de IVA
    Then Obligatorio x Entonces la aplicacion muestra los siguientes campos editables
    Then Obligatorio x Fecha inicio condicion IVA <condicionIva>
    ...
    Examples: 
      ...
      | Empresa         | 30504744538 | 	PEUGEOT CITROEN ARGENTINA S.A. | catfer@email.com | 07/06/2019    | Monotributo  | 14/06/2019   | check     | dato               | variableFiscales@gmail.com |
